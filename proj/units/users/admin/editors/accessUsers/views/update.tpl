<?php
	...
	namespace Proj\Templates\Editor\AccessUsers;
	...
	abstract class Update {
		...
		public static function ToVar(Editor $editor, int $uid, array $collections, array $items, string $title, array $navigate): string {
			Buffering::Start();
			self::Render($editor, $uid, $collections, $items, $title, $navigate);
			return Buffering::Read();
		}

		public static function Render(Editor $editor, int $uid, array $collections, array $items, string $title, array $navigate): void { ?>
			<div class = "navigate">
